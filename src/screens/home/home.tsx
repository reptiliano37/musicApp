...
type HomeProps = {
  ...
  const Header = () => {
    return(
      ...
      <Animatable.Text animation="slideInDown" iterationCount={5} direction="alternate">By Miguel</Animatable.Text>
        <Animatable.Text animation="pulse" easing="ease-out" iterationCount="infinite">❤️</Animatable.Text>
      </>
    )
  }
  const HelpMessage = () =>{
